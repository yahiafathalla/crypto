...
exports.handler = async (event, context) => {
    ...
    const Items = data.map(entry => ({
        ...
        cuurentprice: { N: entry.current_price.toString() },
        image: { S: entry.image },
        name: { S: entry.name },
